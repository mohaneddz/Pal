    ...
    <section className="pal-about-panel">
      ...
      <div className="pal-about-list">
        ...
        <article className="pal-about-card">
          ...
          <p>This build is Windows-only: use <strong>Alt + 1..5</strong> for page jumps and <strong>Ctrl</strong> for the rest.</p>
          ...
          <ul className="pal-shortcuts-list">
            ...
            <li><kbd>Ctrl + Shift + D</kbd><span>Free RAM (destroy main window, keep tray alive)</span></li>
